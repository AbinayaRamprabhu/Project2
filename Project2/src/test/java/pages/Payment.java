...
public class Payment {
	  @FindBy(css = "input[data-qa='name-on-card']")
	    ...
	    public Payment fillPaymentDetails() throws IOException, ParseException {
	    ...
	    public Payment downloadInvoiceButtonClick() {
	        downloadInvoiceButton.click();
	        return this;
	    }

	    public Homepage continueButtonClick() {
	        Locators.waitForElementToBeClickable(driver, continueButton);
